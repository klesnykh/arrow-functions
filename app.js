...
// this is the object that joe is, which is a student
// 2. What is "this" when joe.scopeArrow() is invoked?
// the global window object
// 3. Explain why "this" is different when an arrow function is used.
// arrow functions do not have their own 'this', they should only be used for non-method functions, that's why it shows the global window object
